...
public class CountryList {
    ...
    public Country findCountryMinPopulation()
    {
        Country c1=new Country("No country",9999999999999L,0,0);
        for(Country c: countryList)
        {
            if(c1.getPopulation() > c.getPopulation())
                {
                    c1 = c;
                }
    ...
    public Country findCountryMaxPopulation()
    {
        Country c1=new Country("No country",0,0,0);
        for(Country c: countryList)
        {
            if(c1.getPopulation() < c.getPopulation())
            {
    ...
    public Country findCountryMinAge()
    {
        Country c1=new Country("No country",0,0,9999);
        for(Country c: countryList)
        {
            if(c1.getMedianAge() > c.getMedianAge())
            {
                c1 = c;
            }
    ...
    public Country findCountryMaxAge()
    {
        Country c1=new Country("No country",0,0,-1);
        for(Country c: countryList)
        {
            if(c1.getMedianAge() < c.getMedianAge())
            {
...
//    public Country findCountryMedianAge()
//    {
//
//        for(Country c: countryList)
//        {
